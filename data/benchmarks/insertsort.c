...
void initialise_benchmark(); // Explicit prototype declaration for re-initialization routine
...
benchmark (void)
{
  ...
  int w;
  for (w = 0; w < 5; w++) {
    initialise_benchmark(); // Re-initialize array a[] back to its unsorted state
