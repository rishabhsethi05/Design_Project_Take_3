...
void initialise_benchmark(); // Explicit prototype for internal state resetting
...
benchmark (void)
{
  ...
  int w;
  for (w = 0; w < 5; w++) {
    initialise_benchmark(); // Re-initialize x and y to preserve deterministic swap orientation
