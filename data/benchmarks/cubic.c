...
// Internal processing function kept exactly as original
void SolveCubic_Internal(double  a,
      double  b,
      double  c,
      double  d,
      int    *solutions,
...
// Public API matching original signature with 5x execution multiplier loop
void SolveCubic(double  a,
      ...
      double *x)
{
   // --- ADDED FOR 5X WORKLOAD ---
   int w;
   for (w = 0; w < 5; w++)
   {
      SolveCubic_Internal(a, b, c, d, solutions, x);
   }
   // -----------------------------
}
